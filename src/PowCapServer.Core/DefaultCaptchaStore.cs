...
public class DefaultCaptchaStore : ICaptchaStore
{
    ...
    public static string ChallengeTokenCachePrefix { get; set; } = "Captcha:ChallengeToken:";

    public static string CaptchaTokenCachePrefix { get; set; } = "Captcha:CaptchaToken:";
